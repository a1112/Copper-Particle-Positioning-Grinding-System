...
RowLayout {
  spacing: 8
  Rectangle { width: 10; height: 10; radius: 5; color: Datas.StatusDatas.connected ? "#22c55e" : "#ef4444" }
  Label { text: (Datas.StatusDatas.connected ? "已连接" : "未连接"); color: Cores.CoreStyle.text }
  Label {
    id: latency
