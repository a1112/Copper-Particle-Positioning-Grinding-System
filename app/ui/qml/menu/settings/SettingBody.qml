        ...
        contentItem: Column {
            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    Label { text: qsTr("编号"); font.bold: true; color: "#9ad"; Layout.preferredWidth: 80 }
                    Label { text: qsTr("名称"); font.bold: true; color: "#9ad"; Layout.fillWidth: true }
                    Label { text: qsTr("直径"); font.bold: true; color: "#9ad"; Layout.preferredWidth: 80; horizontalAlignment: Qt.AlignRight }
                    Label { text: qsTr("长度"); font.bold: true; color: "#9ad"; Layout.preferredWidth: 80; horizontalAlignment: Qt.AlignRight }
                }
            }
