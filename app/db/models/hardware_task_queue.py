...
from sqlalchemy import BigInteger, DateTime, Index, JSON, text, String, Integer, Text
...
class HardwareTaskQueue(Base):
    ...
    device_id: Mapped[str] = mapped_column(String(64, 'utf8mb4_unicode_ci'), nullable=False, comment='设备标识ID')
