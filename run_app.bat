...
echo [INFO] Installing dependencies from default PyPI (pypi.org)...
pip install -i https://pypi.org/simple -r requirements.txt
if errorlevel 1 (
    echo [WARN] pip install encountered errors. If packages are already present, launch may still work.
)
